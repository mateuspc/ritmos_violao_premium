    ...
    return ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: (){
              Navigator.pushNamed(context, AppRoutes.PAGE_DETAILS, arguments: _ritmos[index]);
            },
            child: Container(
                 ...
                 return Column(
                   ...
                   children: [
                       ...
                       child: Row(
                         ...
                         children: [
                           ...
                           if(_ritmos[index].isLocked)
                             Icon(FontAwesomeIcons.lock, size: getReferenceHeight(context) * 0.33)
                         ],
                       ),
                     ),
                     ...
                     Center(
                       ...
                       child: Center(
                         child: FittedBox(
                           child: Text(_ritmos[index].sequenciaDedilhado, style: TextStyle(
